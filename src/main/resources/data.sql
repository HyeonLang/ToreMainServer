-- 사용자 테이블 초기 데이터
INSERT INTO users (username, password, playername, wallet_address, created_at, updated_at) VALUES ('admin', 'password', '관리자', '0xC274A22FAC186a684eAaF344402f7b30212b6511', NOW(), NOW()) ON DUPLICATE KEY UPDATE updated_at = NOW();
...
VALUES 
(1, 4, '{"level": 1, "enhancement": 0}', NULL, 2001), -- admin의 철검 (level 1)
(1, 5, '{"level": 1, "enhancement": 0}', NULL, 2002), -- admin의 가죽 갑옷 (level 1)
(1, 4, '{"level": 2, "enhancement": 0}', NULL, 2003), -- admin의 철검 (level 2)
(1, 5, '{"level": 2, "enhancement": 0}', NULL, 2004); -- admin의 가죽 갑옷 (level 2)
